...
public enum CityIdEnumOld {
    ...
    public static CityIdEnumOld getByTypeCode(String code){
        for (CityIdEnumOld cityIdEnum : CityIdEnumOld.values()) {
    ...
    // 构造方法
    CityIdEnumOld(String name, String code) {
        this.name = name;
        this.code = code;
    }
